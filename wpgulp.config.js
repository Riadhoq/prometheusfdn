...
module.exports = {
	...
	// Project options.
	projectURL: 'prometheusfdn.local', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	// Translation options.
	textDomain: 'Prometheus', // Your textdomain here.
	translationFile: 'Prometheus.pot', // Name of the translation file.
	translationDestination: './languages', // Where to save the translation files.
	packageName: 'Prometheus', // Package name.
	bugReport: 'https://AhmadAwais.com/contact/', // Where can users report bugs.
	lastTranslator: 'Riadul Hoque <hoqueriadul@gmail.com>', // Last translator Email ID.
	team: 'Riadul Hoque <hoqueriadul@gmail.com>', // Team's Email ID.
